...
var MochaTestRunner = /** @class */ (function () {
    function MochaTestRunner(runnerOptions) {
        this.log = logging_1.getLogger(MochaTestRunner.name);
        this.mochaRunnerOptions = runnerOptions.strykerOptions[MochaRunnerOptions_1.mochaOptionsKey];
    ...
    MochaTestRunner.prototype.init = function () {
        ...
        this.testFileNames = LibWrapper_1.default.multimatch(this.allFileNames, globPatternsAbsolute);
