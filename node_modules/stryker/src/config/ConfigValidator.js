...
var ConfigValidator = /** @class */ (function () {
    function ConfigValidator(strykerConfig, testFramework) {
        ...
        this.isValid = true;
        this.log = logging_1.getLogger(ConfigValidator.name);
    }
    ...
    ConfigValidator.prototype.validateLogLevel = function (logProperty) {
        var logLevel = this.strykerConfig[logProperty];
    ...
    ConfigValidator.prototype.crashIfNeeded = function () {
        if (!this.isValid) {
            throw new StrykerError_1.default('Stryker could not recover from this configuration error, see fatal log message(s) above.');
        }
    };
